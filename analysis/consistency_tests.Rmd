...
# 12. Cayman Island coral reef trophic network 

```{r}
cayman_raw <- read.delim(url('https://datadryad.org/bitstream/handle/10255/dryad.43421/857470.item.5.dat?sequence=1'), header = F, sep = ' ') %>% 
    mutate(V1 = seq(1:265)) %>% 
    set_colnames(c('', seq(1:265)))
```
