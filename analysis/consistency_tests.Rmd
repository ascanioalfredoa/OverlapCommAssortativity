...
```{r random linkcomm with permutations}
set.seed(1)
...
```{r random linkcomm with bootstrap}
set.seed(1)
Pij_rnd_dis_b <- calc_bmatrix( , 100, 'fastgreedy', permutations = F,
                              boot.data = )
 ...
 * Shizuka’s coefficient (fastgreedy, bootstrap): 
 * Ascanio’s coefficient (linkcomm, permutations): 1
 * Ascanio’s coefficient (fastgreedy, bootstrap):
 * Ascanio’s coefficient (fastgreedy, permutations):