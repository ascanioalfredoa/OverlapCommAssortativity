...
Ascanio’s coefficient: 0.57 (for overlapping communities with permutations)
Ascanio’s coefficient: 0.36 (for fast greedy communities with permutations)
Ascanio's coefficient: 0.90 (for fast greedy communities with bootstrap / must be similar to Shizuka's coefficient)

#2. Tit data

```{r tits graph}
colnames(tit) <- paste("N", as.character(V(tit_g)), sep = "")
...
Pij_tit_dis <- calc_Pmatrix(tit_g, 100, 'fastgreedy', permutations = F, boot.data = tit)
...
Ascanio’s coefficient:  (for overlapping communities with permutations)
Ascanio’s coefficient: 0.33 (for fast greedy communities with permutations)
Ascanio’s coefficient: 0.99 (for fast greedy communities with bootstrap / must be equivalent to Shizuka's coefficient)
...
set.seed(1)
Pij_tho_dis <- calc_Pmatrix(tho_g, 100, 'fastgreedy', permutations = F, boot.data = thornbill)
...
Ascanio’s coefficient:  (for overlapping communities with permutations)
Ascanio’s coefficient: 0.33 (for fast greedy communities with permutations)
Ascanio’s coefficient: 0.62 (for fast greedy communities with boostrap / must be equivalent to Shizuka's coefficient)
